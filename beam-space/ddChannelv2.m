%% DD Channel, ve G Channel implementasyonları kıyaslaması. DD ve G aynı sonucu veriyor.
clear;
close all;
...
yv2 = G*x;
Yddv2 = reshape(yv2, [M, N, Nrf]);

Yddv1 = permute(Yddv1, [2, 1, 3]);
yv1 = Yddv1(:);

my_isequal(yv1, yv2)
my_isequal(Yddv1, Yddv2)
