function params = init_simulation_params(rcs2_dB, rho, nIter, monteCarlo, is_genie, is_data_only)
    ...
    params = v2struct(c, N, M, N_fft, M_fft, fc, delta_f, BW, T, Tcp, Tsym, is_fftshifted, NT, PT_db, PT, noise_fig, N0, sigma2, nIter, K, known_data, pilot_ratio, modulation, pT, pR, positions, velocities, rcs_dB, rcs, lambda, taus, nus, alphas, tau_idx, nu_idx, tau_res, nu_res, delay_array, doppler_array, ref_target_idx, monteCarlo, is_data_only, is_genie);
end
